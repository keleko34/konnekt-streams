...
var cli = require('commander').version('0.0.1'),
...
module.exports = (function(){
  ...
  function runCommand(commandName,options){
      ...
      /* Run prompt command */
      inquirer.prompt(_prompts[commandName]).then(method(commandName,options));
  }
  ...
  function Base(){
    ...
    _taskCommands = global.taskrunner.config.Tasks[_task].commands;
  ...
  Base.task = function(v){
    ...
    _task = (typeof v === 'string' && global.taskrunner.config.Tasks[v] !== undefined ? v : _task);
    return Base;
  }
